...
private:
   ...
   //THESE ARE ADDITIONAL PRIVATE FUNCTIONS
   //ALL OF THEM ARE RECURSIVE HELPER FUNCTIONS TO GIVEN PUBLIC FUNCTIONS
   void insertHelper(TreeNode* inserter_, DBentry* newEntry_, string name_);
   DBentry* finderHelper(string name_, TreeNode* finder_);
   DBentry* noProbesFinderHelper(string name_, TreeNode* finder_);
   void printHelper(TreeNode* current_);
   int countHelper(TreeNode* current) const;
...
public:
   ...
   //updates status
   void updateStatus (string name_, bool status_); 
