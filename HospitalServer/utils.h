...
struct config_params {
	...
	node* head [MAX_TABLES];
	int tableCount;
	char tableCol[MAX_TABLES][MAX_COLUMNS_PER_TABLE][MAX_COLNAME_LEN];
	int tableColCount [MAX_TABLES];
	int tableColLength[MAX_TABLES][MAX_COLUMNS_PER_TABLE]; // length of table or column, 0 for int
...
int marshallData (struct config_params*params,char *cmd);
